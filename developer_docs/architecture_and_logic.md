...
All application routes are defined in [router.dart](../gamifyphotography/lib/core/router.dart).
...
2. **shadcn/ui + Tailwind CSS**:
   * Located under `src/components/ui/` in the `gamifyphotography-admin` repository.
...
* **Files**: 
  ...
  * Service: [auth_service.dart](../gamifyphotography/lib/services/auth_service.dart)
